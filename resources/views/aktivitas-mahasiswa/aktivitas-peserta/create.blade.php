            ...
            <form action="{{ route('aktivitas-peserta.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <label for="aktivitas_mahasiswa_id">Kode Aktivitas</label>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-control" id="program_studi_id" name="program_studi_id">
                            ...
                            @foreach ($programStudi as $prodi)
                                <option value="{{ $prodi->id }}">{{ $prodi->kode_prodi }} - {{ $prodi->nama_program_studi }}</option>
                            @endforeach
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="jenis_peran" id="jenis_peran" class="form-control">
                            <option value="1" {{ old('jenis_peran') == '1' ? 'selected' : '' }}>Ketua</option>
                            <option value="2" {{ old('jenis_peran') == '2' ? 'selected' : '' }}>Anggota</option>
                            <option value="3" {{ old('jenis_peran') == '3' ? 'selected' : '' }}>Personal</option>
                        </select>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control" id="nilai_huruf" name="nilai_huruf" placeholder="Nilai Huruf">
                        @error('nilai_huruf')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-md-4 mb-3">
                        ...
                        <select name="nilai_indeks" id="nilai_indeks" class="form-control">
                            <option value="1" {{ old('nilai_indeks') == '1' ? 'selected' : '' }}>0</option>
                            <option value="2" {{ old('nilai_indeks') == '2' ? 'selected' : '' }}>1</option>
                            <option value="3" {{ old('nilai_indeks') == '3' ? 'selected' : '' }}>2</option>
                            <option value="4" {{ old('nilai_indeks') == '4' ? 'selected' : '' }}>3</option>
                            <option value="5" {{ old('nilai_indeks') == '5' ? 'selected' : '' }}>4</option>
                        </select>
                    </div>

                    <div class="col-md-4 mb-3">
                        <label for="nilai_angka">Nilai Angka</label>
                        <input type="text" class="form-control" id="nilai_angka" name="nilai_angka" placeholder="Nilai Angka">
                        @error('nilai_angka')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
