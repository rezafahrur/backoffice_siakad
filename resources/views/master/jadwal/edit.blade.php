                        ...
                        <div class="row mb-3">
                            <div class="col-md-4">
                                ...
                                <select name="details[{{ $detail->id }}][jadwal_hari]" class="form-control" required>
                                    <option value="1" {{ $detail->jadwal_hari == 1 ? 'selected' : '' }}>Senin</option>
                                    <option value="2" {{ $detail->jadwal_hari == 2 ? 'selected' : '' }}>Selasa
                                    </option>
                                    <option value="3" {{ $detail->jadwal_hari == 3 ? 'selected' : '' }}>Rabu</option>
                                    <option value="4" {{ $detail->jadwal_hari == 4 ? 'selected' : '' }}>Kamis</option>
                                    <option value="5" {{ $detail->jadwal_hari == 5 ? 'selected' : '' }}>Jumat</option>
                                    <option value="6" {{ $detail->jadwal_hari == 6 ? 'selected' : '' }}>Sabtu</option>
