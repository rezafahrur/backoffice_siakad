           ...
           {{-- Tanggal Lahir --}}
            ...
            <div class="mb-3">
                ...
                <select class="form-select @error('jenis_kelamin') is-invalid @enderror" id="jenis_kelamin"
                    name="jenis_kelamin">
                    <option value="L" {{ old('jenis_kelamin', $hr->ktp->jenis_kelamin) == 'L' ? 'selected' : '' }}>
                        Laki-laki</option>
                    <option value="P" {{ old('jenis_kelamin', $hr->ktp->jenis_kelamin) == 'P' ? 'selected' : '' }}>
                        Perempuan</option>
                </select>
                @error('jenis_kelamin')
                    <div class="invalid-feedback">
          ...
          {{-- Agama --}}
            ...
            <div class="mb-3">
                ...
                <select class="form-select @error('golongan_darah') is-invalid @enderror" id="golongan_darah"
                    ...
                    <option value="A" {{ old('golongan_darah', $hr->ktp->golongan_darah) == 'A' ? 'selected' : '' }}>A
                    </option>
                    <option value="A+" {{ old('golongan_darah', $hr->ktp->golongan_darah) == 'A+' ? 'selected' : '' }}>A+
                    </option>
                    <option value="A-" {{ old('golongan_darah', $hr->ktp->golongan_darah) == 'A-' ? 'selected' : '' }}>A-
                    </option>
                    <option value="B" {{ old('golongan_darah', $hr->ktp->golongan_darah) == 'B' ? 'selected' : '' }}>B
                    </option>
                    <option value="B+" {{ old('golongan_darah', $hr->ktp->golongan_darah) == 'B+' ? 'selected' : '' }}>B+
                    </option>
                    <option value="B-" {{ old('golongan_darah', $hr->ktp->golongan_darah) == 'B-' ? 'selected' : '' }}>B-
                    </option>
                    <option value="AB" {{ old('golongan_darah', $hr->ktp->golongan_darah) == 'AB' ? 'selected' : '' }}>AB
                    </option>
                    <option value="AB+" {{ old('golongan_darah', $hr->ktp->golongan_darah) == 'AB+' ? 'selected' : '' }}>
                        AB+</option>
                    <option value="AB-" {{ old('golongan_darah', $hr->ktp->golongan_darah) == 'AB-' ? 'selected' : '' }}>
                        AB-</option>
                    <option value="O" {{ old('golongan_darah', $hr->ktp->golongan_darah) == 'O' ? 'selected' : '' }}>O
                    </option>
                    <option value="O+" {{ old('golongan_darah', $hr->ktp->golongan_darah) == 'O+' ? 'selected' : '' }}>O+
                    </option>
                    <option value="O-" {{ old('golongan_darah', $hr->ktp->golongan_darah) == 'O-' ? 'selected' : '' }}>O-
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('kewarganegaraan') is-invalid @enderror"
                    ...
                    value="{{ old('kewarganegaraan', $hr->ktp->kewarganegaraan) ? strtoupper(old('kewarganegaraan', $hr->ktp->kewarganegaraan)) : '' }}"
                    oninput="this.value = this.value.toUpperCase()">
            ...
            <div class="mb-3">
                ...
                <select class="form-select @error('position_id') is-invalid @enderror" id="position_id" name="position_id">
                    ...
                    @foreach ($positions as $position)
                        <option value="{{ $position->id }}" {{ old('position_id', $hr->position->posisi) == $position->id ? 'selected' : '' }}>
                            {{ $position->posisi }}
                        </option>
                    @endforeach
                </select>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('gelar_depan') is-invalid @enderror" id="gelar_depan"
                    ...
                    value="{{ old('gelar_depan', $hr->gelar_belakang) ? strtoupper(old('gelar_depan', $hr->gelar_depan)) : '' }}"
                    oninput="this.value = this.value.toUpperCase()">
                @error('gelar_depan')
                    <div class="invalid-feedback">
                        {{ $message }}
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('gelar_belakang') is-invalid @enderror" id="gelar_belakang"
                    ...
                    value="{{ old('gelar_belakang', $hr->gelar_belakang) ? strtoupper(old('gelar_belakang', $hr->gelar_belakang)) : '' }}"
                    oninput="this.value = this.value.toUpperCase()">
