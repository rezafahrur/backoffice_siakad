...
@section('content')
    <nav class="page-breadcrumb">
        ...
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Edit Human Resource</h4>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('nik') is-invalid @enderror"
                                        ...
                                        value="{{ old('nik', $hr->ktp->nik) }}" maxlength="16"
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('nip') is-invalid @enderror"
                                        id="nip" name="nip" placeholder="NIP" value="{{ old('nip', $hr->nip) }}"
                                        maxlength="18"
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control @error('lahir_tgl') is-invalid @enderror"
                                        ...
                                        value="{{ old('lahir_tgl', $hr->ktp->lahir_tgl) }}">
                                    @error('lahir_tgl')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input @error('jenis_kelamin') is-invalid @enderror"
                                            type="radio" id="laki_laki" name="jenis_kelamin" value="L"
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input @error('jenis_kelamin') is-invalid @enderror"
                                            type="radio" id="perempuan" name="jenis_kelamin" value="P"
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('hp') is-invalid @enderror"
                                        id="hp" name="hp" placeholder="No. HP"
                                        value="{{ old('hp', $hr->hrDetail->hp) }}"
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-select @error('golongan_darah') is-invalid @enderror"
                                    ...
                                    <option value="A"
                                        {{ old('golongan_darah', $hr->ktp->golongan_darah) == 'A' ? 'selected' : '' }}>A
                                    </option>
                                    <option value="B"
                                        {{ old('golongan_darah', $hr->ktp->golongan_darah) == 'B' ? 'selected' : '' }}>B
                                    </option>
                                    <option value="AB"
                                        {{ old('golongan_darah', $hr->ktp->golongan_darah) == 'AB' ? 'selected' : '' }}>AB
                                    </option>
                                    <option value="O"
                                        {{ old('golongan_darah', $hr->ktp->golongan_darah) == 'O' ? 'selected' : '' }}>O
                                    </option>
                                </select>
