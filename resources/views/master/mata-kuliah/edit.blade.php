        ...
        <div class="card-body">
            ...
            <form action="{{ route('mata-kuliah.update', $matkul->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="sks_praktek" class="form-control @error('sks_praktek') is-invalid @enderror"
                        id="sks_praktek" value="{{ old('sks_praktek', $matkul->sks_praktek) }}">
                    @error('sks_praktek')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="sks_praktek_lapangan"
                        class="form-control @error('sks_praktek_lapangan') is-invalid @enderror" id="sks_praktek_lapangan"
                ...
                <div class="mb-3">
                    ...
                    <input type="date" name="tgl_mulai_efektif"
                        class="form-control @error('tgl_mulai_efektif') is-invalid @enderror" id="tgl_mulai_efektif"
                ...
                <div class="mb-3">
                    ...
                    <input type="date" name="tgl_akhir_efektif"
                        class="form-control @error('tgl_akhir_efektif') is-invalid @enderror" id="tgl_akhir_efektif"
