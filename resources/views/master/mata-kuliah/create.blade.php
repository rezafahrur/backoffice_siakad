    ...
    <div class="card-body">
        <form action="{{ route('mata-kuliah.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control @error('sks_tatap_muka') is-invalid @enderror" id="sks_tatap_muka"
                    name="sks_tatap_muka" placeholder="Masukan jumlah SKS Tatap Muka"
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control @error('sks_praktek_lapangan') is-invalid @enderror"
                    id="sks_praktek_lapangan" name="sks_praktek_lapangan" placeholder="Masukan jumlah SKS Praktek Lapangan"
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('metode_belajar') is-invalid @enderror" id="metode_belajar"
                    name="metode_belajar" placeholder="Masukan Metode Belajar" value="{{ old('metode_belajar') }}">
