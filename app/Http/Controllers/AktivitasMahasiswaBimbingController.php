...
class AktivitasMahasiswaBimbingController extends Controller
{
    public function index()
    {
        ...
        return view('aktivitas-mahasiswa.aktivitas-bimbing-uji.index', compact('bimbingUji'));
    }

    public function create()
    {
        $aktivitas = AktivitasMahasiswa::all();
        return view('aktivitas-mahasiswa.aktivitas-bimbing-uji.create', compact('aktivitas'));
    }
    ...
    public function show($id)
    {
        ...
        return view('aktivitas-mahasiswa.aktivitas-bimbing-uji.show', compact('bimbingUji'));
    }
    ...
    public function edit($id)
    {
        $bimbingUji = AktivitasMahasiswaBimbing::findOrFail($id);
        $aktivitas = AktivitasMahasiswa::all();
        return view('aktivitas-mahasiswa.aktivitas-bimbing-uji.edit', compact('bimbingUji', 'aktivitas'));
    }
